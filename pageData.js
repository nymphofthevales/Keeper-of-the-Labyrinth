...
mainGallery.addItem(2,true,'The Obelisk','','./assets/obelisk.png',false)
mainGallery.addItem(3,true,'Runes','An unused inventory sprite created early in development.','./assets/runes_item.png',false)
mainGallery.addItem(4,true,'Wand','An unused inventory sprite created early in development.','./assets/wand_item.png',false)
mainGallery.addItem(5,true,'Candles','An unused inventory sprite created early in development.','./assets/candles_item.png',false)
mainGallery.addItem(6,true,'Chalk','An unused inventory sprite created early in development.','./assets/chalk_item.png',false)
mainGallery.addItem(7,true,'Knife','An unused inventory sprite created early in development.','./assets/knife_item.png',false)
