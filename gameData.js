...
windowIntersectionCandle.addOption('Take the left fork',leftDark1);
windowIntersectionCandle.addOption('Take the right fork',darkApproachTree);
...
//v map presets
let mapPresets = {
    antechamber: {"width":20,"height":13,"tiles":[[[13,4],"v>"],[[14,4],"<v>"],[[15,4],"<>"],[[16,4],"<v"],[[5,5],"v>"],[[6,5],"<>"],[[10,5],"v>"],[[11,5],"<>"],[[12,5],"<>"],[[13,5],"<^"],[[14,5],"^v"],[[17,5],"<v"],[[5,6],"^v"],[[7,6],"^v"],[[9,6],"v>"],[[11,6],"<v"],[[13,6],"v>"],[[15,6],"<v"],[[17,6],"^v"],[[3,7],"<>"],[[4,7],"<>"],[[8,7],"<>"],[[9,7],"<^v"],[[10,7],"^v"],[[11,7],"^v>"],[[12,7],"<>"],[[13,7],"<^v"],[[14,7],"^v"],[[15,7],"^v>"],[[17,7],"<^v>"],[[18,7],"<>"],[[5,8],"^v"],[[7,8],"^v"],[[9,8],"^>"],[[11,8],"<^"],[[13,8],"^>"],[[15,8],"<^"],[[17,8],"^v"],[[5,9],"^>"],[[6,9],"<>"],[[10,9],"^>"],[[11,9],"<>"],[[12,9],"<>"],[[13,9],"<v"],[[14,9],"^v"],[[17,9],"<^"],[[13,10],"^>"],[[14,10],"<^>"],[[15,10],"<>"],[[16,10],"<^"]],"nodes":[[[7,5],"<v","Left",false,"LEntry"],[[16,5],"^>","Move on",false,"MoveOnAnte"],[[10,6],"<^v>","The Obelisk",false,"obelisk"],[[14,6],"<^v>","Light a candle",false,"CandleAnte"],[[2,7],">","Intro",true,"intro"],[[5,7],"<^v","Enter",false,"enter"],[[7,7],"^v>","The Antechamber",false,"ante"],[[16,7],"<>","Leave",false,"LeaveAnte"],[[19,7],"<","The Labyrinth Proper",false,"LabyrinthProper"],[[10,8],"<^v>","A Witch's Tools",false,"inventory"],[[14,8],"<^v>","The Ritual of Runes",false,"castRunes"],[[7,9],"<^","Right",false,"REntry"],[[16,9],"v>","Move on",false,"MoveOnAnte"]]},
