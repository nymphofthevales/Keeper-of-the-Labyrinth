...
darkNoisesGiveUp.setText('I decide to give up—this song shall remain a mystery to me tonight. It still calls out behind me as I turn heel and return down the hall, but it recedes with every step. I reach the intersection, and another path remains open to me. The path winds away, curving out of sight. Looking off into the distance I see a silhouette against the sky towering over it.');
...
darkNoisesReflection.addPage('I recoil in horror, straining to break free of it, but it holds fast. More black tendrils reach out toward me, wrapping around my other hand and torso, and I feel it pull me towards the opening. Breaking the surface feels like diving into ice-water, sending reverberations down my spine and shock crashing over my head and—','next')
...
//v map presets
let mapPresets = {
    antechamber: {"width":20,"height":13,"tiles":[[[13,4],"v>"],[[14,4],"<v>"],[[15,4],"<>"],[[16,4],"<v"],[[5,5],"v>"],[[6,5],"<>"],[[10,5],"v>"],[[11,5],"<>"],[[12,5],"<>"],[[13,5],"<^"],[[14,5],"^v"],[[17,5],"<v"],[[5,6],"^v"],[[7,6],"^v"],[[9,6],"v>"],[[11,6],"<v"],[[13,6],"v>"],[[15,6],"<v"],[[17,6],"^v"],[[3,7],"<>"],[[4,7],"<>"],[[8,7],"<>"],[[9,7],"<^v"],[[10,7],"^v"],[[11,7],"^v>"],[[12,7],"<>"],[[13,7],"<^v"],[[14,7],"^v"],[[15,7],"^v>"],[[17,7],"<^v>"],[[18,7],"<>"],[[5,8],"^v"],[[7,8],"^v"],[[9,8],"^>"],[[11,8],"<^"],[[13,8],"^>"],[[15,8],"<^"],[[17,8],"^v"],[[5,9],"^>"],[[6,9],"<>"],[[10,9],"^>"],[[11,9],"<>"],[[12,9],"<>"],[[13,9],"<v"],[[14,9],"^v"],[[17,9],"<^"],[[13,10],"^>"],[[14,10],"<^>"],[[15,10],"<>"],[[16,10],"<^"]],"nodes":[[[7,5],"<v","Left",false],[[16,5],"^>","Move on",false],[[10,6],"<^v>","The Obelisk",false],[[14,6],"<^v>","Light a candle",false],[[2,7],">","Intro",true],[[5,7],"<^v","Enter",false],[[7,7],"^v>","The Antechamber",false],[[16,7],"<>","Leave",false],[[19,7],"<","The Labyrinth Proper",false],[[10,8],"<^v>","A Witch's Tools",false],[[14,8],"<^v>","The Ritual of Runes",false],[[7,9],"<^","Right",false],[[16,9],"v>","Move on",false]]},
    labyrinthProper: {"width":40,"height":15,"tiles":[[[4,5],"v>"],[[5,5],"<v"],[[6,5],"v>"],[[7,5],"<v"],[[8,5],"v>"],[[9,5],"<v"],[[10,5],"v>"],[[11,5],"<v"],[[20,5],"v>"],[[22,5],"<v"],[[30,5],"v>"],[[31,5],"<v"],[[5,6],"^v"],[[6,6],"^v"],[[7,6],"^v"],[[8,6],"^v"],[[9,6],"^v"],[[10,6],"^v"],[[11,6],"^v"],[[12,6],"v>"],[[13,6],"<>"],[[14,6],"<>"],[[15,6],"<>"],[[16,6],"<v"],[[21,6],"<v"],[[22,6],"^>"],[[23,6],"<v"],[[30,6],"^v"],[[31,6],"^>"],[[33,6],"<v"],[[4,7],"^v"],[[5,7],"^>"],[[6,7],"<^"],[[7,7],"^>"],[[8,7],"<^"],[[9,7],"^>"],[[10,7],"<^"],[[11,7],"^v"],[[12,7],"^v"],[[13,7],"v>"],[[15,7],"<v"],[[16,7],"^>"],[[17,7],"<v"],[[20,7],"^v"],[[21,7],"^>"],[[22,7],"<>"],[[23,7],"<^>"],[[29,7],"v>"],[[31,7],"<>"],[[32,7],"<v"],[[33,7],"^>"],[[34,7],"<v"],[[3,8],"<>"],[[4,8],"<^v"],[[5,8],"v>"],[[7,8],"<>"],[[9,8],"<>"],[[10,8],"<v"],[[11,8],"^>"],[[12,8],"<^"],[[13,8],"^v"],[[15,8],"^>"],[[16,8],"<v>"],[[17,8],"<^>"],[[19,8],"<>"],[[20,8],"<^>"],[[21,8],"<>"],[[22,8],"<>"],[[23,8],"<>"],[[24,8],"<^>"],[[25,8],"<>"],[[26,8],"<v"],[[28,8],"v>"],[[29,8],"<^"],[[34,8],"^v"],[[36,8],"v>"],[[4,9],"^>"],[[5,9],"<^"],[[6,9],"^v"],[[8,9],"^v"],[[10,9],"^>"],[[11,9],"<>"],[[12,9],"<v>"],[[14,9],"<>"],[[15,9],"<>"],[[16,9],"<^"],[[26,9],"^>"],[[27,9],"<>"],[[29,9],"<>"],[[31,9],"<>"],[[32,9],"<^v>"],[[33,9],"<>"],[[34,9],"<^v>"],[[35,9],"<>"],[[36,9],"<^"],[[6,10],"^>"],[[7,10],"<>"],[[8,10],"<^>"],[[10,10],"<>"],[[12,10],"<^"],[[13,10],"^v"],[[28,10],"^>"],[[29,10],"<v"],[[11,11],"^>"],[[13,11],"<^"],[[29,11],"^>"],[[31,11],"<>"],[[32,11],"<^>"],[[33,11],"<>"],[[34,11],"<^"]],"nodes":[[[21,5],"<>","Watching",false],[[4,6],"^v","Left",false],[[20,6],"^v>","Mossy Corner",false],[[32,6],"<>","Pressing",false],[[14,7],"<>","Investigate",false],[[24,7],"<v","Turn Back",false],[[30,7],"<^>","Squeeze through?",false],[[2,8],">","Labyrinth Proper",true],[[6,8],"<v>","Fleeing",false],[[8,8],"<v>","Run",false],[[18,8],"<>","Mazes & Labyrinths",false],[[32,8],"^v","Carry on",false],[[37,8],"<","Growth & Change",false],[[13,9],"<^v>","Shadow Chamber",false],[[28,9],"<^v>","Wall",false],[[30,9],"<>","Leave it alone",false],[[9,10],"<>","Turn",false],[[11,10],"<v>","Run",false],[[32,10],"^v","Leave the candle",false],[[34,10],"^v","Save the candle",false],[[12,11],"<>","Check Again",false],[[30,11],"<>","Ritual of Lines",false]]},
