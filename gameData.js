...
Changing.addBatchPage(['She looks me up and down one more time, with compassion in her eyes, then gives me a satisfied nod.<br><br>\"It\'s okay.\"','I am obsolete. I know that she is better than me, deserves to take my place. She\'s me but more. It\'s scary to see her go on, to know that whatever being that now takes my name and shape in the world will be something different than I once was, but also good.','Two things are true:<ul><li>One, that she carries me with her, and always will. I am an inevitable ghost in her body; my residue is what makes her me.</li><li>Two, that I will remain here, lost in the labyrinth. Pieces of me will never be known again, forgotten in the twisting halls of this place.</li><ul>For the sake of the former, I know she will try not to resent the latter.','Maybe I will resent it. After all; I will not be gone, not dead, really. Simply left behind. And she will go on in change: she will be better, more free, more whole, just more, for every experience I brought her from my journey in the labyrinth; and I\'m sure she will believe that leaving me behind, or letting me leave myself behind, was the right choice for our sake.<br><br>I trust her.','I take a seat upon the edge of the altar, and watch her leave. She gives me one last smile, then waves like it\'s nothing—like she\'s a friend on her way home after dinner—with no special affect—as if she\'ll see me again tomorrow, and it\'s all just another normal farewell.','I smile back.','I brush a hand across the wall of the archway as I exit. Leaving her sitting there upon the altar, I can\'t help thinking one thing: I\'m glad she gets a chance to rest.'],'next');
...
Lights.setNext(LightsEnd)

const LightsVarShadow = new Sequence();
LightsVarShadow.title="LightsVarShadow"
LightsVarShadow.addBatchPage(['I stand in place and sway gently for a moment, letting the dark music take me. It comes in waves, with no clear origin, and as they wash over me I feel a strange pleasure from somewhere deep within me. Before I know it I am dancing, whirling through the dark like a solar flare lashing out into the void.', 'People say there can be no shadow without light—but in fact, the inverse is also true. There can be no light without shadow. Darkness gives shape to light, defines its boundaries; alongside shadow, light becomes more real. If there were only light, it would be just as formless of a void as if there were only darkness. They define each other in balance.', 'Darkness pulls from the pits and recesses of the world, ever so gently on the light as the moon pulls the sea, tugging at each other like eager young lovers, undulating back and forth, melting into each other.', 'The light of day is called a bright and pure thing, the summer sun revealing beauty, but light too can reveal the festering wounds of the world, the cracks in the formless ruin we all call home. Shadow is the birthplace of monsters, they say, but shadow too is the birthplace of the universe, a womb for us all, and a mother that will outlast any of us in her beauty. A harsh goddess, perhaps, or at least an inscrutable one, but benevolent too; kind enough to hide that which is ugly in the world when we can bear to see it no longer.', 'As I dance the walls of the pit whirl around me, and I can feel that midnight mother watching over me. My shadow was stolen before, when I gazed deep into her navel and it was hollow, or rather it was borrowed for its time—it had been chasing me after all, hellish and strange assailant as it was.'],'Dance')
LightsVarShadow.addPage('Just as my shadow was twisted against me in the light of the evening when I begun my task, so it shall meet me again in the darkness as I near the centre, returned to my side as a friend once more. I feel the darkness take her place behind me as my dance ignites warmth in the chamber. A light rises on my skin and I see: all the walls are covered in candles, each in their own alcove, gushing forth wax like tears. With each step I take they come to life, their flames dancing with me. And I know that no matter where I go, there is a light within me that I can cultivate. I can burn brighter than the sun, if I let myself dance without fear.','Slow to a stand');
LightsVarShadow.addPage('I slow, and looking down in the place between the lights I see her: my shadow.<br><br>She dances still, wavering in the candle-glow. I have an ally in darkness now, too.', 'next')
LightsVarShadow.addPage(' I fall to my knees, exhausted but energized, and rest a moment.','rise')
LightsVarShadow.setNext(LightsEnd)
...
StrangerSpeak.addBatchPage(['I ask if she\'s lost.','She starts at the sound of my voice, and a shiver passes through her whole body like a storm-warning, deep in the bones.<br><br>.She replies in a calm and steady voice, cold even, though not unfamiliar. She speaks in tones of soil and stone, deep and smooth and grounded.','She says she <i>is</i>. lost. That she\'s been lost for a long time. That she has wandered here for an age.'],'next');
